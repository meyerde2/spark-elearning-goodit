        ...
        <div class="col-md-8">
            ...
            <div class="col-md-3">
                 ...
                 <label for="category1">Kategorie 1</label>
                    <select id="category1" name="category1" class="form-control">
                      <optgroup label="Kategorie">
                        <option value="1" #if($question.getCatId1() == 1) selected #end>${msg.get("PLANSPIEL_CATEGORY_A")}</option>
                        <option value="2" #if($question.getCatId1() == 2) selected #end>${msg.get("PLANSPIEL_CATEGORY_B")}</option>
                        <option value="3" #if($question.getCatId1() == 3) selected #end>${msg.get("PLANSPIEL_CATEGORY_C")}</option>
                      </optgroup>
                    </select>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <select id="category2" name="category2" class="form-control">
                      <optgroup label="Kategorie">
                        <option value="1" #if($question.getCatId2() == 1) selected #end>${msg.get("PLANSPIEL_CATEGORY_A")}</option>
                        <option value="2" #if($question.getCatId2() == 2) selected #end>${msg.get("PLANSPIEL_CATEGORY_B")}</option>
                        <option value="3" #if($question.getCatId2() == 3) selected #end>${msg.get("PLANSPIEL_CATEGORY_C")}</option>
                      </optgroup>
                    </select>
                </div>
            </div>
           ...
           <div class="form-group">
                ...
                <div class="col-md-3">
                 <label for="category3">Kategorie 3</label>
                    <select id="category3" name="category3" class="form-control">
                      <optgroup label="Kategorie">
                        <option value="1" #if($question.getCatId3() == 1) selected #end>${msg.get("PLANSPIEL_CATEGORY_A")}</option>
                        <option value="2" #if($question.getCatId3() == 2) selected #end>${msg.get("PLANSPIEL_CATEGORY_B")}</option>
                        <option value="3" #if($question.getCatId3() == 3) selected #end>${msg.get("PLANSPIEL_CATEGORY_C")}</option>
                      </optgroup>
                    </select>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="answer4" class="form-control" placeholder="${msg.get("PLANSPIEL_ANSWER4")}" value="$question.getAnswer4()}" required>
                </div>
                <div class="col-md-3">
                    <label for="category4">Kategorie 4</label>
                    <select id="category4" name="category4" class="form-control">
                      <optgroup label="Kategorie">
                        <option value="1" #if($question.getCatId4() == 1) selected #end>${msg.get("PLANSPIEL_CATEGORY_A")</option>
                        <option value="2" #if($question.getCatId4() == 2) selected #end>${msg.get("PLANSPIEL_CATEGORY_B")</option>
                        <option value="3" #if($question.getCatId4() == 3) selected #end>${msg.get("PLANSPIEL_CATEGORY_C")</option>
                      </optgroup>
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-3">
                ...
                <input type="text" name="answer5" class="form-control" placeholder="${msg.get("PLANSPIEL_ANSWER5")" value="$question.getAnswer5()" required>
            </div>
                <div class="col-md-3">
                 <label for="category1">Kategorie 5</label>
                    <select id="category5" name="category5" class="form-control">
                      <optgroup label="Kategorie">
                        <option value="1" #if($question.getCatId5() == 1) selected #end>${msg.get("PLANSPIEL_CATEGORY_A")}</option>
                        <option value="2" #if($question.getCatId5() == 2) selected #end>${msg.get("PLANSPIEL_CATEGORY_B")}</option>
                        <option value="3" #if($question.getCatId5() == 3) selected #end>${msg.get("PLANSPIEL_CATEGORY_C")}</option>
                      </optgroup>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
               ...
               <input type="checkbox" name="active" id="active" class="" #if($question.isActive() == true) checked #end placeholder="${msg.get("PLANSPIEL_IS_ACTIVE")}" value="true" required>
            </div>
