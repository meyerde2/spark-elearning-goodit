   ...
   <div class="form-group">
    ...
    <div class="custom-controls-stacked">
      ...
      <label class="custom-control custom-radio">
        <input id="role" name="role" type="radio" class="custom-control-input" value="1" #if($user.getRole() == 1) checked #end>
      ...
      <label class="custom-control custom-radio">
        <input id="role" name="role" type="radio" class="custom-control-input" value="2" #if($user.getRole() == 2) checked #end>
        <span class="custom-control-indicator"></span>
